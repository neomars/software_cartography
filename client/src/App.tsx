...
function App() {
  ...
  const [activeDataset, setActiveDataset] = useState('SDAN');

  useEffect(() => {
    getSettings().then(res => {
      setAppName(res.data.appName);
      setActiveDataset(res.data.activeDataset || 'SDAN');
    }).catch(() => {});
  }, []);
        ...
        <nav className="w-64 bg-white shadow-md flex flex-col">
          <div className="p-6 border-b">
            ...
            <div className="bg-blue-50 rounded-lg p-3">
              <div className="flex items-center text-[10px] text-blue-600 font-bold uppercase tracking-wider mb-1">
